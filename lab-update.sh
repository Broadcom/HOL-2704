...
if [ -f /home/holuser/Documents/files/addoninstall-istio.yaml ]; then
    mv -f /home/holuser/Documents/files/addoninstall-istio.yaml /home/holuser/Documents/addoninstall-istio.yaml
fi
